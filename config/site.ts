...
export const siteConfig = {
  ...
  about: {
    ...
    bio: [
      "Software Engineer with 3+ years experience currently working as a Blockchain Engineer. Programming since the age of 12, I'm a jack-of-all-trades programmer.",
